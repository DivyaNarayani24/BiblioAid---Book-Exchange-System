...
function App() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const user = { id: res.userId, name: res.name, email: res.email };
      setCurrentUser(user);
    ...
    <div className="app">
      <div className="main-container">
        ...
        <div className="nav-buttons">
          ...
          <button
            className={`nav-btn ${currentPage === 'my-books' ? 'active' : ''}`}
        ...
        <div className="content-card">
          {currentPage === 'search' && (
            <SearchBook currentUser={currentUser} />
          )}
          {currentPage === 'donate' && (
            <AddBookForm type="donate" currentUser={currentUser} setCurrentPage={setCurrentPage} />
          )}
          {currentPage === 'sell' && (
            <AddBookForm type="sell" currentUser={currentUser} setCurrentPage={setCurrentPage} />
          )}
          {currentPage === 'request' && (
            <RequestBookForm currentUser={currentUser} setCurrentPage={setCurrentPage} />
          )}
          {currentPage === 'my-requests' && (
            <RequestList currentUser={currentUser} setCurrentPage={setCurrentPage} />
          )}
          {currentPage === 'my-books' && (
            <MyBooks currentUser={currentUser} setCurrentPage={setCurrentPage} />
          )}
        </div>
